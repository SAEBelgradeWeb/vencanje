...
This WordPress plugin has been built to, automatically format your **featured content** the way you want, display **more information in a limited space** to catch users, prevent article authors to break your WordPress theme layout and to **focus only on content**, display a **news carousel** on your home page or in **sidebar widgets** positions
...
* Select your **display options** ie. apply a theme, choose the row and column number,…
...
* 1.0.1. Stable release of 2014-04-24 ( compatible with [pro add-on v.1.0.0](http://www.wpcode-united.com/wordpress-plugin/wp-frontpage-news) )
* 1.0.0. Stable release of 2014-04-18 ( compatible with [pro add-on v.1.0.0](http://www.wpcode-united.com/wordpress-plugin/wp-frontpage-news) )
* 0.2.4. Beta 5 release of 2014-01-21 ( compatible with [pro add-on v.0.2.0](http://www.wpcode-united.com/wordpress-plugin/wp-frontpage-news) )
* 0.2.3. Beta 4 release of 2013-12-12 ( compatible with [pro add-on v.0.2.0](http://www.wpcode-united.com/wordpress-plugin/wp-frontpage-news) )
...
= 1.0.1 =
* WP 3.9 / TinyMCE 4.0 compatibility release
...
= 1.0.1 =
* No specifics. Automatic upgrade works fine. Adds WordPress 3.9 full compatibility.
= 1.0.0 =
...
* No specifics. Automatic upgrade works fine.
= 1.0.0 =
* No specifics. Automatic upgrade works fine. Pro users also need to upgrade the pro add-on to version 1.0.0.
